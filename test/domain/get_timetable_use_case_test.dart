...
void main() {
  ...
  test('that can fetch all timetable from network', () {
    when(mockRepository.getTimetableData("hey", "ho")).thenAnswer((_) => MockRadiocoRepository.timetables());
  ...
  test('that can fetch all timetable when error in network', () {
    when(mockRepository.getTimetableData("hey", "ho")).thenAnswer((_) => MockRadiocoRepository.timetables(isEmpty: true));
